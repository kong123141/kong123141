...
namespace EndifsCreations.Plugins
{
    class Morgana : PluginData
    {
        ...
        private void LoadMenus()
        {
            ...
            {
                custommenu.AddItem(new MenuItem("EC.Morgana.UseRKey", "Key").SetValue(new KeyBind(Root.Item("CustomMode_Key").GetValue<KeyBind>().Key, KeyBindType.Press)));  //T
        ...
        private void Combo()
        {
            ...
            var UseQ = Root.Item("EC.Morgana.Combo.Q").GetValue<bool>();
            var UseW = Root.Item("EC.Morgana.Combo.W").GetValue<bool>();
            if (Target.IsValidTarget())
            {
                ...
                try
                {
                    ...
                    {
                        mySpellcast.CircularAoe(Target, W, HitChance.High, W.Range, 175);
                    }
                }
                catch { }
            }
        ...
        private void Harass()
        {
            var UseQ = Root.Item("EC.Morgana.Harass.Q").GetValue<bool>();
            var UseW = Root.Item("EC.Morgana.Harass.W").GetValue<bool>();
        ...
        {
            if (myUtility.PlayerManaPercentage < Root.Item("EC.Morgana.Farm.ManaPercent").GetValue<Slider>().Value) return;
            if (Player.UnderTurret(true)) return;
            if (Root.Item("EC.Morgana.Farm.Q").GetValue<bool>() && Q.IsReady() && !Player.IsWindingUp)
            {
            ...
            if (Root.Item("EC.Morgana.Farm.W").GetValue<bool>() && W.IsReady() && !Player.IsWindingUp)
            {
                ...
                if (wpred.MinionsHit > Root.Item("EC.Morgana.Farm.W.Value").GetValue<Slider>().Value)
                {
        ...
        private void JungleClear()
        {
            ...
            if (mob != null)
            {
                if (Root.Item("EC.Morgana.Jungle.Q").GetValue<bool>() && Q.IsReady() && Q.IsInRange(mob) && !Player.IsWindingUp)
                {
                    if (largemobs != null)
                    {
                ...
                if (Root.Item("EC.Morgana.Jungle.W").GetValue<bool>() && W.IsReady() && !Player.IsWindingUp)
                {
                    if (largemobs != null)
                    {
                ...
                if (Root.Item("EC.Morgana.Jungle.E").GetValue<bool>() && E.IsReady() && !Player.IsWindingUp)
                {
                    if (largemobs != null)
                    {
                        E.Cast();
        ...
        {
            switch (Root.Item("EC.Morgana.QPredHitchance").GetValue<StringList>().SelectedIndex)
            {
                case 0:
        ...
        protected override void OnProcessSpellCast(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs spell)
        {
            ...
            {
                if (Root.Item("EC.Morgana.UseESupport").GetValue<bool>())
                {
            ...
            {
                if ((myOrbwalker.ActiveMode == myOrbwalker.OrbwalkingMode.Combo && Root.Item("EC.Morgana.Combo.E").GetValue<bool>()) ||
                    (myOrbwalker.ActiveMode == myOrbwalker.OrbwalkingMode.Harass && Root.Item("EC.Morgana.Harass.E").GetValue<bool>()) ||
                    (Root.Item("EC.Morgana.Misc.E").GetValue<bool>())
                    )
                {
        ...
        {
            if (Root.Item("EC.Morgana.Misc.Q").GetValue<bool>() && Q.IsReady())
            {
        ...
        {
            if (Root.Item("EC.Morgana.Misc.Q2").GetValue<bool>() && Q.IsReady())
            {
            ...
            if (Root.Item("EC.Morgana.Misc.W").GetValue<bool>() && W.IsReady())
            {
            ...
            if (Root.Item("EC.Morgana.Misc.E").GetValue<bool>() && E.IsReady())
            {
        ...
        protected override void OnDraw(EventArgs args)
        {
            ...
            if (Root.Item("EC.Morgana.Draw.Q").GetValue<bool>() && Q.Level > 0)
            {
                Render.Circle.DrawCircle(Player.Position, Q.Range, Color.White);
            }
            if (Root.Item("EC.Morgana.Draw.W").GetValue<bool>() && W.Level > 0)
            {
                Render.Circle.DrawCircle(Player.Position, W.Range, Color.White);
            }
            if (R.Level > 0 && R.IsReady())
            {
                if (Root.Item("EC.Morgana.UseRDrawDistance").GetValue<bool>())
                {
                ...
                if (Root.Item("EC.Morgana.UseRDrawTarget").GetValue<bool>())
                {
                    var EnemyList = HeroManager.Enemies.Where(x => x.IsValidTarget() && !x.IsDead && !x.IsZombie && !x.IsInvulnerable && !myUtility.ImmuneToCC(x) && !myUtility.ImmuneToMagic(x));
