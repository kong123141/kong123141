...
namespace EndifsCreations.Plugins
{
    class Amumu  : PluginData
    {
        ...
        private void Combo()
        {
            ...
            var UseQ = Root.Item("EC.Amumu.Combo.Q").GetValue<bool>();
            var UseW = Root.Item("EC.Amumu.Combo.W").GetValue<bool>();
            var UseE = Root.Item("EC.Amumu.Combo.E").GetValue<bool>();
            var UseR = Root.Item("EC.Amumu.Combo.R").GetValue<bool>();

            var CastItems = Root.Item("EC.Amumu.Combo.Items").GetValue<bool>();
        ...
        protected override void OnDraw(EventArgs args)
        {
            ...
            if (Root.Item("EC.Amumu.Draw.Q").GetValue<bool>() && Q.Level > 0)
            {
                Render.Circle.DrawCircle(Player.Position, Q.Range, Color.White);
            }
            if (Root.Item("EC.Amumu.Draw.E").GetValue<bool>() && E.Level > 0)
            {
                Render.Circle.DrawCircle(Player.Position, E.Range, Color.White);
            }
            if (Root.Item("EC.Amumu.Draw.R").GetValue<bool>() && R.Level > 0)
            {
