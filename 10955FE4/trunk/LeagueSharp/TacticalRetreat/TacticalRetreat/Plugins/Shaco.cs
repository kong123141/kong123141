...
namespace TacticalRetreat.Plugins
{
    internal class Shaco
    {
        ...
        {
            {new Spell(SpellSlot.Q, 400), EscapeType.Dash},
            {new Spell(SpellSlot.W, 425), EscapeType.Self},
            {new Spell(SpellSlot.E, 625), EscapeType.Enemy},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Shaco", "Shaco"));
