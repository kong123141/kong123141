...
namespace TacticalRetreat.Plugins
{
    internal class Pantheon
    {
        ...
        private static readonly Dictionary<Spell, EscapeType> spells = new Dictionary<Spell, EscapeType>
        {
            ...
            {new Spell(SpellSlot.W, 600), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 600), EscapeType.Not},
            {new Spell(SpellSlot.R, 5500), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Pantheon", "Pantheon"));
