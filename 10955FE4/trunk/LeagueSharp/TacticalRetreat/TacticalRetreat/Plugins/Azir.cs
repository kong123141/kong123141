...
namespace TacticalRetreat.Plugins
{
    internal class Azir
    {
        ...
        {
            {new Spell(SpellSlot.Q, 875), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 450), EscapeType.Dash},
            {new Spell(SpellSlot.E, 875), EscapeType.Dash},
            {new Spell(SpellSlot.R, 250), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Azir", "Azir"));
