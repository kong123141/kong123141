...
namespace TacticalRetreat.Plugins
{
    internal class Ashe
    {
        ...
        {
            {new Spell(SpellSlot.Q, 0), EscapeType.Self},
            {new Spell(SpellSlot.W, 1200), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 10000), EscapeType.Not},
            {new Spell(SpellSlot.R, 10000), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Ashe", "Ashe"));
