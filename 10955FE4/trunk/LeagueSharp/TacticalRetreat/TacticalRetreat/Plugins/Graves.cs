...
namespace TacticalRetreat.Plugins
{
    internal class Graves
    {
        ...
        {
            {new Spell(SpellSlot.Q, 950), EscapeType.Not},
            {new Spell(SpellSlot.W, 950), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 425), EscapeType.Dash},
            {new Spell(SpellSlot.R, 1000), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Graves", "Graves"));
