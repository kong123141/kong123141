...
namespace TacticalRetreat.Plugins
{
    internal class Gragas
    {
        ...
        {
            //TODO: Second activation of Q.
            {new Spell(SpellSlot.Q, 850), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 0), EscapeType.Not},
            {new Spell(SpellSlot.E, 600), EscapeType.Dash},
            {new Spell(SpellSlot.R, 600), EscapeType.Enemy} //Purposefully lower to make sure they're pushed back.
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Gragas", "Gragas"));
