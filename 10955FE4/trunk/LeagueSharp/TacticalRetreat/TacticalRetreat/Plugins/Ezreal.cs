...
namespace TacticalRetreat.Plugins
{
    internal class Ezreal
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1150), EscapeType.Not},
            {new Spell(SpellSlot.W, 1000), EscapeType.Not},
            {new Spell(SpellSlot.E, 475), EscapeType.Dash},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Ezreal", "Ezreal"));
