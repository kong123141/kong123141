...
namespace TacticalRetreat.Plugins
{
    internal class Anivia
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1075), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 1000), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 650), EscapeType.Not},
            {new Spell(SpellSlot.R,  625), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Anivia", "Anivia"));
