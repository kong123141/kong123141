...
namespace TacticalRetreat.Plugins
{
    internal class Jayce
    {
        ...
        {
            //TODO: Account for form changes. Currently assumes ranged.
            {new Spell(SpellSlot.Q, 1050), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Not},
            {new Spell(SpellSlot.E, 650), EscapeType.Self},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Jayce", "Jayce"));
