...
namespace TacticalRetreat.Plugins
{
    internal class LeeSin
    {
        ...
        {
            //TODO: Add smart Q to minions, add smart W to wards.
            {new Spell(SpellSlot.Q, 1100), EscapeType.Dash},
            {new Spell(SpellSlot.W, 700), EscapeType.Dash},
            {new Spell(SpellSlot.E, 350), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 375), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("LeeSin", "LeeSin"));
