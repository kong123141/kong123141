...
namespace TacticalRetreat.Plugins
{
    internal class Diana
    {
        ...
        {
            {new Spell(SpellSlot.Q, 830), EscapeType.Not},
            {new Spell(SpellSlot.W, 200), EscapeType.Self},
            {new Spell(SpellSlot.E, 350), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 825), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Diana", "Diana"));
