...
namespace TacticalRetreat.Plugins
{
    internal class Zyra
    {
        ...
        {
            {new Spell(SpellSlot.Q, 800), EscapeType.Not},
            {new Spell(SpellSlot.W, 850), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 1100), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 700), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Zyra", "Zyra"));
