...
namespace TacticalRetreat.Plugins
{
    internal class Lissandra
    {
        ...
        {
            //TODO: Fix Lissandra E auto activating.
            {new Spell(SpellSlot.Q, 725), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 450), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 1050), EscapeType.Dash},
            {new Spell(SpellSlot.R, 550), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Lissandra", "Lissandra"));
