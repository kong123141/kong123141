...
namespace TacticalRetreat.Plugins
{
    internal class Ekko
    {
        ...
        private static readonly Dictionary<Spell, EscapeType> spells = new Dictionary<Spell, EscapeType>
        {
            ...
            {new Spell(SpellSlot.W, 1600), EscapeType.Self},
            {new Spell(SpellSlot.E, 325), EscapeType.Dash},
            {new Spell(SpellSlot.R, 1000000), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Ekko", "Ekko"));
