...
namespace TacticalRetreat.Plugins
{
    internal class Elise
    {
        ...
        {
            //TODO: DIFFERENTIATE BETWEEN FORMS. RIGHT NOW ASSUMES HUMAN FORM.
            {new Spell(SpellSlot.Q, 625), EscapeType.Not},
            {new Spell(SpellSlot.W, 950), EscapeType.Not},
            {new Spell(SpellSlot.E, 1075), EscapeType.Enemy},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Elise", "Elise"));
