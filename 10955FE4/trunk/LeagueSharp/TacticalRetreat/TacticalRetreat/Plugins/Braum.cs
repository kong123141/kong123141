...
namespace TacticalRetreat.Plugins
{
    internal class Braum
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1000), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 650), EscapeType.Dash},
            {new Spell(SpellSlot.E, 0), EscapeType.Self},
            {new Spell(SpellSlot.R, 1250), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Braum", "Braum"));
