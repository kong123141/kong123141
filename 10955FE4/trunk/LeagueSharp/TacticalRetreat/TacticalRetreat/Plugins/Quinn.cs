...
namespace TacticalRetreat.Plugins
{
    internal class Quinn
    {
        ...
        {
            //TODO: Not make Quinn auto go back to human from Valor.
            //This currently assumes you're in Valor form.
            {new Spell(SpellSlot.Q, 1025), EscapeType.Not},
            {new Spell(SpellSlot.W, 2100), EscapeType.Not},
            {new Spell(SpellSlot.E, 700), EscapeType.Not},
            {new Spell(SpellSlot.R, 0), EscapeType.Self}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Quinn", "Quinn"));
