...
namespace TacticalRetreat.Plugins
{
    internal class Singed
    {
        ...
        {
            //TODO: Activate poison trail toggle for running away.
            {new Spell(SpellSlot.Q, 0), EscapeType.Not},
            {new Spell(SpellSlot.W, 1000), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 125), EscapeType.Not},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Singed", "Singed"));
