...
namespace TacticalRetreat.Plugins
{
    internal class Xerath
    {
        ...
        {
            {new Spell(SpellSlot.Q, 750), EscapeType.Not},
            {new Spell(SpellSlot.W, 1100), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 1050), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 3200), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Xerath", "Xerath"));
