...
namespace TacticalRetreat.Plugins
{
    internal class Karthus
    {
        ...
        {
            {new Spell(SpellSlot.Q, 875), EscapeType.Not},
            {new Spell(SpellSlot.W, 1000), EscapeType.Self},
            {new Spell(SpellSlot.E, 425), EscapeType.Not},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Karthus", "Karthus"));
