...
namespace TacticalRetreat.Plugins
{
    internal class Mordekaiser
    {
        ...
        {
            {new Spell(SpellSlot.Q, 600), EscapeType.Not},
            {new Spell(SpellSlot.W, 750), EscapeType.Not},
            {new Spell(SpellSlot.E, 700), EscapeType.Not},
            {new Spell(SpellSlot.R, 850), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Mordekaiser", "Mordekaiser"));
