...
namespace TacticalRetreat.Plugins
{
    internal class Lulu
    {
        ...
        {
            {new Spell(SpellSlot.Q, 925), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 650), EscapeType.Self},
            {new Spell(SpellSlot.E, 650), EscapeType.Not},
            {new Spell(SpellSlot.R, 900), EscapeType.Self}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Lulu", "Lulu"));
