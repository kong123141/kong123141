...
namespace TacticalRetreat.Plugins
{
    internal class Zac
    {
        ...
        {
            //TODO: Use E to slingshot away.
            {new Spell(SpellSlot.Q, 550), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 350), EscapeType.Not},
            {new Spell(SpellSlot.E, 500), EscapeType.Dash},
            {new Spell(SpellSlot.R, 300), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Zac", "Zac"));
