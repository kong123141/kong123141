...
namespace TacticalRetreat.Plugins
{
    internal class Blitzcrank
    {
        ...
        {
            {new Spell(SpellSlot.Q, 650), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Self},
            {new Spell(SpellSlot.E, 15), EscapeType.Not},
            {new Spell(SpellSlot.R, 325), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Blitzcrank", "Blitzcrank"));
