...
namespace TacticalRetreat.Plugins
{
    internal class TwistedFate
    {
        ...
        {
            //TODO: Card selection for yellow card to stun.
            {new Spell(SpellSlot.Q, 1450), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Not},
            {new Spell(SpellSlot.E, 0), EscapeType.Not},
        ...
        {
            rootMenu.AddSubMenu(new Menu("TwistedFate", "TwistedFate"));
