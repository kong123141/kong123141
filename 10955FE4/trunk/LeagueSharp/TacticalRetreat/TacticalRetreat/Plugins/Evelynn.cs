...
namespace TacticalRetreat.Plugins
{
    internal class Evelynn
    {
        ...
        {
            {new Spell(SpellSlot.Q, 500), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Self},
            {new Spell(SpellSlot.E, 225), EscapeType.Not},
            {new Spell(SpellSlot.R, 650), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Evelynn", "Evelynn"));
