...
namespace TacticalRetreat.Plugins
{
    internal class Fiddlesticks
    {
        ...
        {
            {new Spell(SpellSlot.Q, 575), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 575), EscapeType.Not},
            {new Spell(SpellSlot.E, 750), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 800), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Fiddlesticks", "Fiddlesticks"));
