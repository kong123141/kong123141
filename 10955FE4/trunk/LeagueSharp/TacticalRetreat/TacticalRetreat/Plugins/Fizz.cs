...
namespace TacticalRetreat.Plugins
{
    internal class Fizz
    {
        ...
        {
            {new Spell(SpellSlot.Q, 550), EscapeType.Dash},
            {new Spell(SpellSlot.W, 0), EscapeType.Not},
            {new Spell(SpellSlot.E, 400), EscapeType.Dash},
            {new Spell(SpellSlot.R, 1275), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Fizz", "Fizz"));
