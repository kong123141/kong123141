...
namespace TacticalRetreat.Plugins
{
    internal class Heimerdinger
    {
        ...
        {
            //Todo: Include upgrade.
            {new Spell(SpellSlot.Q, 450), EscapeType.Not},
            {new Spell(SpellSlot.W, 1100), EscapeType.Not},
            {new Spell(SpellSlot.E, 925), EscapeType.Enemy},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Heimerdinger", "Heimerdinger"));
