...
namespace TacticalRetreat.Plugins
{
    internal class Tristana
    {
        ...
        private static readonly Dictionary<Spell, EscapeType> spells = new Dictionary<Spell, EscapeType>
        {
            ...
            {new Spell(SpellSlot.W, 900), EscapeType.Dash},
            {new Spell(SpellSlot.E, 543), EscapeType.Not},
            {new Spell(SpellSlot.R, 585), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Tristana", "Tristana"));
