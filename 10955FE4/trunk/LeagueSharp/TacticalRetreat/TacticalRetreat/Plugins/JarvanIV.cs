...
namespace TacticalRetreat.Plugins
{
    internal class JarvanIV
    {
        ...
        {
            //Doing Jarvan's spells in odd order to help with combo order.
            {new Spell(SpellSlot.E, 830), EscapeType.Dash},
            {new Spell(SpellSlot.Q, 770), EscapeType.Dash},
            {new Spell(SpellSlot.W, 300), EscapeType.Self},
            {new Spell(SpellSlot.R, 650), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Jarvan IV", "Jarvan IV"));
