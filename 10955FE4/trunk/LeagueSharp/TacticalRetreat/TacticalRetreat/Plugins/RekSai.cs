...
namespace TacticalRetreat.Plugins
{
    internal class RekSai
    {
        ...
        {
            //TODO: Account for which state Reksai is in.
            //This assumes Reksai is burrow already.
            {new Spell(SpellSlot.Q, 1650), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Not},
            {new Spell(SpellSlot.E, 250), EscapeType.Dash},
            {new Spell(SpellSlot.R, 10000), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("RekSai", "RekSai"));
