...
namespace TacticalRetreat.Plugins
{
    internal class Syndra
    {
        ...
        {
            //TODO: Work on E stun refinement.
            {new Spell(SpellSlot.Q, 800), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 925), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 700), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 675), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Syndra", "Syndra"));
