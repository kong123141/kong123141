...
namespace TacticalRetreat.Plugins
{
    internal class Nidalee
    {
        ...
        {
            //Todo: Account for 2 forms. Currently only assumes Cougar form
            {new Spell(SpellSlot.Q, 1500), EscapeType.Not},
            {new Spell(SpellSlot.W, 375), EscapeType.Dash},
            {new Spell(SpellSlot.E, 300), EscapeType.Not},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Nidalee", "Nidalee"));
