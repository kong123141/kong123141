...
namespace TacticalRetreat.Plugins
{
    internal class Maokai
    {
        ...
        {
            {new Spell(SpellSlot.Q, 600), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 525), EscapeType.Dash},
            {new Spell(SpellSlot.E, 1100), EscapeType.Self},
            {new Spell(SpellSlot.R, 475), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Maokai", "Maokai"));
