...
namespace TacticalRetreat.Plugins
{
    internal class Jinx
    {
        ...
        {
            {new Spell(SpellSlot.Q, 150), EscapeType.Not},
            {new Spell(SpellSlot.W, 1500), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 900), EscapeType.Self},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Jinx", "Jinx"));
