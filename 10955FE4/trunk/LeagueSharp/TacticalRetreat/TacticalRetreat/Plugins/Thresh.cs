...
namespace TacticalRetreat.Plugins
{
    internal class Thresh
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1100), EscapeType.Not},
            {new Spell(SpellSlot.W, 950), EscapeType.Self},
            {new Spell(SpellSlot.E, 400), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 450), EscapeType.Self}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Thresh", "Thresh"));
