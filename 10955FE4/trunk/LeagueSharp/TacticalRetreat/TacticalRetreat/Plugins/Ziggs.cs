...
namespace TacticalRetreat.Plugins
{
    internal class Ziggs
    {
        ...
        {
            {new Spell(SpellSlot.Q, 850), EscapeType.Not},
            {new Spell(SpellSlot.W, 1000), EscapeType.Self},
            {new Spell(SpellSlot.E, 900), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 5300), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Ziggs", "Ziggs"));
