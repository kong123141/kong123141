...
namespace TacticalRetreat.Plugins
{
    internal class Warwick
    {
        ...
        {
            //TODO: Toggle on E, because it's never bad when running away.
            {new Spell(SpellSlot.Q, 400), EscapeType.Not},
            {new Spell(SpellSlot.W, 1250), EscapeType.Not},
            {new Spell(SpellSlot.E, 1500), EscapeType.Self},
            {new Spell(SpellSlot.R, 700), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Warwick", "Warwick"));
