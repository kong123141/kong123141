...
namespace TacticalRetreat.Plugins
{
    internal class Zilean
    {
        ...
        {
            //Switched order of spells for Zilean combo.
            {new Spell(SpellSlot.Q, 900), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 550), EscapeType.Self},
            {new Spell(SpellSlot.W, 0), EscapeType.Self},
            {new Spell(SpellSlot.R, 900), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Zilean", "Zilean"));
