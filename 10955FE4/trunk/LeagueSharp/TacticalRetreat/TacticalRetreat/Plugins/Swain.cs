...
namespace TacticalRetreat.Plugins
{
    internal class Swain
    {
        ...
        {
            {new Spell(SpellSlot.Q, 625), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 900), EscapeType.Enemy},
            {new Spell(SpellSlot.E, 625), EscapeType.Not},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Swain", "Swain"));
