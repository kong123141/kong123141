...
namespace TacticalRetreat.Plugins
{
    internal class Galio
    {
        ...
        {
            {new Spell(SpellSlot.Q, 940), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 800), EscapeType.Not},
            {new Spell(SpellSlot.E, 1180), EscapeType.Dash},
            {new Spell(SpellSlot.R, 600), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Galio", "Galio"));
