...
namespace TacticalRetreat.Plugins
{
    internal class Katarina
    {
        ...
        {
            //TODO: Add Katarina ward jump.
            {new Spell(SpellSlot.Q, 675), EscapeType.Not},
            {new Spell(SpellSlot.W, 375), EscapeType.Enemy},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Katarina", "Katarina"));
