...
namespace TacticalRetreat.Plugins
{
    internal class Zed
    {
        ...
        {
            //TODO: Fix instant recall to W. Add E logic around W.
            {new Spell(SpellSlot.Q, 900), EscapeType.Not},
            {new Spell(SpellSlot.W, 550), EscapeType.Dash},
            {new Spell(SpellSlot.E, 290), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 625), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Zed", "Zed"));
