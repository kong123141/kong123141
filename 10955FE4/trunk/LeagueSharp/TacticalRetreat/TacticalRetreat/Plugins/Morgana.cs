...
namespace TacticalRetreat.Plugins
{
    internal class Morgana
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1175), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 900), EscapeType.Not},
            {new Spell(SpellSlot.E, 750), EscapeType.Not},
            {new Spell(SpellSlot.R, 600), EscapeType.Self}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Morgana", "Morgana"));
