...
namespace TacticalRetreat.Plugins
{
    internal class Leona
    {
        ...
        {
            //TODO: Add AA to stun
            {new Spell(SpellSlot.Q, 125), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 275), EscapeType.Not},
            {new Spell(SpellSlot.E, 875), EscapeType.Not},
            {new Spell(SpellSlot.R, 1200), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Leona", "Leona"));
