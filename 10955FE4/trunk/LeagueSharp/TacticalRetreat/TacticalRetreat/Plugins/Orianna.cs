...
namespace TacticalRetreat.Plugins
{
    internal class Orianna
    {
        ...
        {
            {new Spell(SpellSlot.Q, 825), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Self},
            {new Spell(SpellSlot.E, 1100), EscapeType.Not},
            {new Spell(SpellSlot.R, 400), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Orianna", "Orianna"));
