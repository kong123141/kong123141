...
namespace TacticalRetreat.Plugins
{
    internal class Janna
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1100), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 600), EscapeType.Not},
            {new Spell(SpellSlot.E, 800), EscapeType.Not},
            {new Spell(SpellSlot.R, 725), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Janna", "Janna"));
