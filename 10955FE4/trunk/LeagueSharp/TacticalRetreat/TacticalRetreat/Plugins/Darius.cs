...
namespace TacticalRetreat.Plugins
{
    internal class Darius
    {
        ...
        {
            {new Spell(SpellSlot.Q, 425), EscapeType.Not},
            {new Spell(SpellSlot.W, 145), EscapeType.Not},
            {new Spell(SpellSlot.E, 550), EscapeType.Not},
            {new Spell(SpellSlot.R, 460), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Darius", "Darius"));
