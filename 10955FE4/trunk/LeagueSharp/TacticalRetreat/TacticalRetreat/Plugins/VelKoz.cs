...
namespace TacticalRetreat.Plugins
{
    internal class VelKoz
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1050), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 1050), EscapeType.Not},
            {new Spell(SpellSlot.E, 850), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 1550), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("VelKoz", "VelKoz"));
