...
namespace TacticalRetreat.Plugins
{
    internal class Ahri
    {
        ...
        {
            {new Spell(SpellSlot.Q, 880), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 550), EscapeType.Not},
            {new Spell(SpellSlot.E, 975), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 450), EscapeType.Dash}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Ahri", "Ahri"));
