...
namespace TacticalRetreat.Plugins
{
    internal class Wukong
    {
        ...
        {
            {new Spell(SpellSlot.Q, 125), EscapeType.Not},
            {new Spell(SpellSlot.W, 0), EscapeType.Self},
            {new Spell(SpellSlot.E, 625), EscapeType.Dash},
            {new Spell(SpellSlot.R, 162.5f), EscapeType.Enemy}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Wukong", "Wukong"));
