...
namespace TacticalRetreat.Plugins
{
    internal class Hecarim
    {
        ...
        {
            {new Spell(SpellSlot.Q, 350), EscapeType.Not},
            {new Spell(SpellSlot.W, 525), EscapeType.Not},
            {new Spell(SpellSlot.E, 0), EscapeType.Self},
            {new Spell(SpellSlot.R, 1000), EscapeType.Dash}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Hecarim", "Hecarim"));
