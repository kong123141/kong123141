...
namespace TacticalRetreat.Plugins
{
    internal class Caitlyn
    {
        ...
        {
            {new Spell(SpellSlot.Q, 1250), EscapeType.Not},
            {new Spell(SpellSlot.W, 800), EscapeType.Self},
            {new Spell(SpellSlot.E, 950), EscapeType.Enemy},
            {new Spell(SpellSlot.R, 2000), EscapeType.Not}
        };
        ...
        {
            rootMenu.AddSubMenu(new Menu("Caitlin", "Caitlin"));
