...
namespace TacticalRetreat.Plugins
{
    internal class Alistar
    {
        ...
        {
            {new Spell(SpellSlot.Q, 365), EscapeType.Enemy},
            {new Spell(SpellSlot.W, 650), EscapeType.Not},
            {new Spell(SpellSlot.E, 575), EscapeType.Not},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Alistar", "Alistar"));
