...
namespace TacticalRetreat.Plugins
{
    internal class Renekton
    {
        ...
        {
            //TODO: Implement AA to stun with W.
            {new Spell(SpellSlot.Q, 225), EscapeType.Not},
            {new Spell(SpellSlot.W, 125), EscapeType.Not},
            {new Spell(SpellSlot.E, 450), EscapeType.Dash},
        ...
        {
            rootMenu.AddSubMenu(new Menu("Renekton", "Renekton"));
