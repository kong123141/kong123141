namespace Flowers_Utility.Common.Evade
{
    ...
    public static class Utils
    {
        ...
        public static int ImmobileTime(Obj_AI_Base unit)
        {
            ...
            {
                if (buff.IsActive && Game.Time <= buff.EndTime && (buff.Type == BuffType.Charm || buff.Type == BuffType.Knockup || buff.Type == BuffType.Stun || buff.Type == BuffType.Suppression || buff.Type == BuffType.Snare))
                {
